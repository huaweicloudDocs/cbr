...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CBR&api=ListVault)中调试该接口。
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>每页显示条目数，正整数</p>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>状态</p>
</td>
</tr>
</tbody>
</table>
...
<a name="response_VaultListResp"></a>
