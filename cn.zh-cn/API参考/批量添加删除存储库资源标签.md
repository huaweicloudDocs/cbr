# 批量添加删除存储库资源标签<a name="BatchCreateAndDeleteVaultTags"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CBR&api=BatchCreateAndDeleteVaultTags)中调试该接口。
...
<a name="request_BulkCreateAndDeleteVaultTagsReq"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.2"><p>是否必选</p>
</th>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>系统标签列表。</p>
<p>op_service权限可以访问，和tags二选一。</p>
<p>目前TMS调用时只包含一个resource_tag结构体 ，key固定为：_sys_enterprise_project_id。</p>
<p>value是UUID或0,value为0表示默认企业项目。</p>
<p>现在仅支持create操作。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>值。 目前仅会用到企业项目ID，其中默认的企业项目ID为“0”。</p>
</td>
</tr>
</tbody>
</table>
