...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CBR&api=ListPolicies)中调试该接口。
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>策略类型：备份（backup）、复制(replication)</p>
<p>枚举值：</p>
...
<a name="response_PolicyListResp"></a>
