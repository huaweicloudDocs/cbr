...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>成员id，成员id与项目id为同一个。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>共享的备份将存入的存储库，仅支持uuid 更新member状态的时候，如果是接受，必须传入vault_id，如果是拒绝，则无需</p>
</td>
</tr>
</tbody>
</table>
