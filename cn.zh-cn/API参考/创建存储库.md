...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>创建类型，charging_mode为pre_paid必填，按年(year)或者按月(month)</p>
<p>枚举值：</p>
<ul><li><p>year</p>
</li><li><p>month</p>
</li></ul>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>创建类型的数量，charging_mode为pre_paid必填</p>
</td>
</tr>
