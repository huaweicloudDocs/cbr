...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>是否支持自动挂载。ture:支持自动挂载，false：不支持自动挂载</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>规格，崩溃一致性（crash_consistent）或应用一致性（app_consistent）</p>
<p>枚举值：</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>对象类型：云服务器（server），云硬盘（disk）。</p>
<p>枚举值：</p>
<ul><li><p>server</p>
</li><li><p>disk</p>
</li></ul>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>保护类型：备份（backup）、复制(replication)</p>
<p>枚举值：</p>
<ul><li><p>backup</p>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>创建模式，按需：post_paid，包周期：pre_paid，默认为post_paid</p>
<p>缺省值：post_paid</p>
<p>枚举值：</p>
<ul><li><p>post_paid</p>
</li><li><p>pre_paid</p>
...
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>billing</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p><a href="#response_Billing">Billing</a> object</p>
</td>
...
**表 14**  VaultResourceIntancesResp
...
**表 19**  ResourceExtraInfoIncludeVolumes
