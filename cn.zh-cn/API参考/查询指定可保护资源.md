# 查询指定可保护资源<a name="ShowProtectable"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CBR&api=ShowProtectable)中调试该接口。
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>可保护性类型</p>
<p>枚举值：</p>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>可保护资源</p>
</td>
</tr>
</tbody>
</table>
