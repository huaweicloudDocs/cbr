...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CBR&api=DeletePolicy)中调试该接口。

## URI

DELETE /v3/\{project\_id\}/policies/\{policy\_id\}
