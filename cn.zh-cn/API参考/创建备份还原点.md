...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>待备份资源名称，长度限制：0-255</p>
<p>最小长度：0</p>
<p>最大长度：255</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>待备份资源的类型 Enum:[ OS::Nova::Server,  OS::Cinder::Volume,  OS::Ironic::BareMetalServer, OS::Native::Server, OS::Sfs::Turbo]</p>
<p>枚举值：</p>
...
**表 14**  ResourceExtraInfoIncludeVolumes
...
**表 15**  CheckpointCreateSkippedResource
