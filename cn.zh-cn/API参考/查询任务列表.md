...
<p>缺省值：'0daac4c5-6707-4851-97ba-169e36266b66','d1603440-187d-4516-af25-121250c7cc97'</p>
</td>
</tr>
...
```
{"operation_logs" : [{"checkpoint_id" : "string","created_at" : "string","ended_at" : "string","error_info" : {"code" : "string","message" : "string"},"extra_info" : {"backup" : {"app_consistency_error_code" : "string","app_consistency_error_message" : "string","app_consistency_status" : "0","backup_id" : "string","backup_name" : "string","incremental" : ""true""},"common" : {"progress" : 0,"request_id" : "string","task_id" : "string"},"delete" : {"backup_id" : "string","backup_name" : "string"},"sync" : {"sync_backup_num" : 0,"delete_backup_num" : 0,"err_sync_backup_num" : 0},"remove_resources" : {"fail_count" : 0,"total_count" : 0,"resources" : [{"extra_info" : {"exclude_volumes" : [ "string","string"],"include_volumes" : [{"id" : "string","os_version" : "string"}]},"id" : "string","name" : "string","type" : "OS::Nova::Server"}]},"replication" : {"destination_backup_id" : "string","destination_checkpoint_id" : "string","destination_project_id" : "string","destination_region" : "string","source_backup_id" : "string","source_checkpoint_id" : "string","source_project_id" : "string","source_region" : "string","source_backup_name" : "string","destination_backup_name" : "string"},"resource" : {"extra_info" : {"exclude_volumes" : [ "string","string"],"include_volumes" : [{"id" : "string","os_version" : "string"}]},"id" : "string","name" : "string","type" : "OS::Nova::Server"},"restore" : {"backup_id" : "string","backup_name" : "string","target_resource_id" : "string","target_resource_name" : "string"},"vault_delete" : {"fail_count" : 0,"total_count" : 0}},"id" : "string","operation_type" : "backup","policy_id" : "string","project_id" : "string","provider_id" : "string","started_at" : "string","status" : "success","updated_at" : "string","vault_id" : "string","vault_name" : "string"}],"count" : 0}
```
