# 删除指定备份成员<a name="DeleteMember"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CBR&api=DeleteMember)中调试该接口。

## URI

DELETE /v3/\{project\_id\}/backups/\{backup\_id\}/members/\{member\_id\}
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>成员id</p>
</td>
</tr>
